...
def movies_poster(movie_name: str):
    try:
        ...
        return FileResponse(f"/media/tolo/New Volume/PyDeploy Projects/Python_for_Deployment/Christopher_Nolan_API_assignment3/Christopher_Nolan_API/movies_posters/{movie_name}.jpg")
